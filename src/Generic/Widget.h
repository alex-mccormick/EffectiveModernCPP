...
namespace Overriding
{
    ...
    public:
        ...
        FaceBuilder &&withLeftEye(Widget *eye1)
        {
            eye1_ = eye1;
            return std::move(*this);
        }
        FaceBuilder &&withRightEye(Widget *eye2)
        {
            eye2_ = eye2;
            return std::move(*this);
        }
        FaceBuilder &withLeftEyeLValue(Widget *eye1)
        {
            eye1_ = eye1;
            return *this;
        }
        FaceBuilder &withRightEyeLValue(Widget *eye2)
        {
            eye2_ = eye2;
            return *this;
        }
