...
C4_SmartPointers::C4_SmartPointers()
    ...
    this->menuMap["CuriousRecurringTemplatePattern"] = (BookChapter::MenuFunction) &(C4_SmartPointers::CRTP);
    this->menuMap["WeakPtr"] = (BookChapter::MenuFunction) &(C4_SmartPointers::WeakPtr);
}
...
void C4_SmartPointers::CRTP() {
    ...
    auto pWidget2 = std::make_shared<ExWidget>(-1, 2);
